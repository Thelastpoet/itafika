...
This is the most useful thing most people can do. Two kinds of data:
...
4. Open a pull request. In the description, say **how you know** the rate (you ship this route weekly, you called the SACCO, you're an agent, etc.). That source is what keeps the dataset trustworthy.
