/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 45ffc1b2102e1d6a6164da7a5a9fd9f3)
// Runtime types generated with workerd@1.20260603.1 2026-03-10 nodejs_compat
interface __BaseEnv_Env {
	reference_exports: R2Bucket;
	itafika: D1Database;
	ASSETS: Fetcher;
	MODERATOR_TOKENS: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MODERATOR_TOKENS">> {}
}
