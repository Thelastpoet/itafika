...
export type SubmissionTarget = components["schemas"]["SubmissionTarget"];
export type SubmissionOperation = components["schemas"]["SubmissionOperation"];
...
export type ProviderSubmissionRequest = components["schemas"]["ProviderSubmissionRequest"];
export type Submission = components["schemas"]["Submission"];
export type SubmissionDetail = components["schemas"]["SubmissionDetail"];
export type ModeratorReviewRequest = components["schemas"]["ModeratorReviewRequest"];
export type ModeratorRejectRequest = components["schemas"]["ModeratorRejectRequest"];
...
export type ProviderMeResponse = components["schemas"]["ProviderMeResponse"];
export type ProviderBookingStatus = components["schemas"]["ProviderBookingStatus"];
export type ProviderBookingSummary = components["schemas"]["ProviderBookingSummary"];
export type ProviderBookingDetail = components["schemas"]["ProviderBookingDetail"];
export type ProviderBookingRejectRequest = components["schemas"]["ProviderBookingRejectRequest"];
export type ProviderBookingEventRequest = components["schemas"]["ProviderBookingEventRequest"];
export type ReferenceExport = components["schemas"]["ReferenceExport"];
